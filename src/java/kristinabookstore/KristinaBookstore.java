    ...
    public static void main(String[] args) {
     ...
     private static void showInfoNew(List<Object> l,Members m) {
        //List<Cart> cartList= new ArrayList<>();
         ...
         System.out.println("Address:"+m.getAddress()+"\t\t\t\t\t"+"Address:"+l.get(2).toString());
...
//throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
         ...
         System.out.println("Shipping Address\t\t\t\t\t\tBilling Address");
         System.out.println("Name:"+m.getFname()+" "+m.getLname()+"\t\t\t\t\\t\t"+"Address:"+m.getFname()+" "+m.getLname());
    ...
    public static List<Cart> showCart(dao d){
     ...
     private static void editCart(dao d) {
         Scanner sc= new Scanner(System.in);
         //char choice='';
         System.out.println("Enter d to delete; e to edit your cart; Enter to return");
    ...
    public static void userLogin(dao d) throws SQLException{
    Scanner sc= new Scanner(System.in);
